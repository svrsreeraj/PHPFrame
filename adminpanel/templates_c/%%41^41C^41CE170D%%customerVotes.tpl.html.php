<?php /* Smarty version 2.6.19, created on 2011-01-24 02:03:01
         compiled from customerVotes.tpl.html */ ?>
...
<?php endif; ?>
<tr>
	<td class="pageHead"><span id="customervotes"><strong>Customer Votes</strong></div></td>
</tr>
<tr>
	<td>&nbsp;</td>
</tr>
...
Viewing the Voting Details of &nbsp;<strong><?php echo $this->_tpl_vars['actionReturn']['headname']; ?>
</strong>&nbsp; having a total of <strong><?php echo $this->_tpl_vars['actionReturn']['count']; ?>
</strong>
<?php else: ?>Total &nbsp;<strong><?php echo $this->_tpl_vars['actionReturn']['count']; ?>
</strong>&nbsp; Votes
<?php endif; ?>
    </td>
</tr>
...
" name="txt_date_to" id="txt_date_to" readonly=""  class="dateTextBox"/>
							...
							Status
							&nbsp;
							<select name="sel_paid_status">
                            	<option value="0" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_paid_status'] == 0): ?> selected="selected" <?php endif; ?>>All</option>.
								<option value="1" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_paid_status'] == 1): ?> selected="selected" <?php endif; ?>>Purchased</option>
								<option value="2" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_paid_status'] == 2): ?> selected="selected" <?php endif; ?>>Not Purchased</option>
							</select>
							</td>
							<td>
							Redeem Status
							&nbsp;
							<select name="sel_redeem_status">
                            	<option value="0" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_redeem_status'] == 0): ?> selected="selected" <?php endif; ?>>Select</option>.
								<option value="1" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_redeem_status'] == 1): ?> selected="selected" <?php endif; ?>>Redeemed</option>
								<option value="2" <?php if ($this->_tpl_vars['actionReturn']['searchdata']['sel_redeem_status'] == 2): ?> selected="selected" <?php endif; ?>>Not Redeemed</option>
							</select>
							</td>
							</tr>
						</table>
...
&sortField=cd.name&sortMethod=<?php echo $this->_tpl_vars['obj']->getNegativeSort($this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
">
							Deal Name
							<?php echo $this->_tpl_vars['obj']->getSortImage('cd.name',$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortField'],$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>

							</a></th>
                            <th>Purchased</th>
							<th><a href="<?php echo $this->_tpl_vars['obj']->getLink('search','','false'); ?>
&sortField=cv.date_added&sortMethod=<?php echo $this->_tpl_vars['obj']->getNegativeSort($this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
">
							Voted Date
							<?php echo $this->_tpl_vars['obj']->getSortImage('cv.date_added',$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortField'],$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
...
?>
						<tr>
                            ...
                            <?php if ($this->_tpl_vars['data']['paid_status']): ?>
                            <td>Yes</td>
                            <?php endif; ?>
                            <?php if (! $this->_tpl_vars['data']['paid_status']): ?>
                            <td>No</td>
