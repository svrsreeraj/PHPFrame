<?php /* Smarty version 2.6.19, created on 2011-01-15 05:45:32
         compiled from vendorReportSearch.tpl */ ?>
<td>
				<!--search starts here-->
...
" name="txt_join_to" class="dateTextBox"  id="txt_join_to" readonly="" />
							...
							<tr>
								...
								<td width="100"><?php echo $this->_tpl_vars['actionReturn']['searchdata']['salesagent']; ?>
 </td>
								<td>
									Status
								</td>
							...
							<td width="100">
									<?php echo $this->_tpl_vars['actionReturn']['searchdata']['bill_country']; ?>

							</td>
							<td>State</td>
								<td id="id_search_bill_state"><?php echo $this->_tpl_vars['actionReturn']['searchdata']['bill_state']; ?>
</td>
							</tr>
							<tr>
							<td>
