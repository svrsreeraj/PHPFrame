<?php /* Smarty version 2.6.19, created on 2011-01-15 01:15:47
         compiled from commisionReportSearch.tpl */ ?>
			<tr>
				<td>
...
" readonly=""/></td>
								<td>Coupon Shared</td>
								<td>
									<select name="sel_coupon_shared" style="width:100px;">
										<option value="">All</option>
...
">Both</option>
							...
							<tr>
								<td>Amount From </td>
								<td>
										<select name="sel_amount_field_from" style="width:110px;">
...
"  class="nummberOnly"  maxlength="10" size="10" />
							...
							<tr>
								<td>	Amount To	</td>
								<td>
										<select name="sel_amount_field_to" style="width:110px;">
