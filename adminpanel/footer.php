  ...
  <tr>
  	<td>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<td align="center" valign="middle" bgcolor="#8ADEF8" style="padding:20px;"><span class="darkblue" style="padding-top:20px;">Copyright <span class="darkblue" style="padding-top:20px;"> &copy; </span><?php echo date('Y');?>    All rights reserved, Patent Pending 2010. </span></td>
			</tr>
	  </table>
	 </td>
  </tr>
