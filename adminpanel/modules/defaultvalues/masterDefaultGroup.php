...
$tpls["heading"]				=	"Manage Default Groups";
...
//database details
$def_data["table"]				=	constant("CONST_MODULE_DEFAULT_TABLE_GROUP");
$def_data["primary"]			=	"id";
$def_data["name"]				=	"group";
...
//add area
$tpls["addcaption"]				=	"Add Default Groups";
$tpls["addcount"]				=	15;
$tpls["addsplit"]				=	3;
$tpls["addbtnvalue"]			=	"Add Default Groups";
$tpls["savebtnvalue"]			=	"Save";
$tpls["btnsavecancelvalue"]		=	"Cancel";

//update area
$tpls["edithead"]				=	"Edit Default Groups";
