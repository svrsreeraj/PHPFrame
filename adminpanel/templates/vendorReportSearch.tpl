					...
					<div id="id_search_block" class="cls_search_block">
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="searchTable">
							...
							<tr>
								...
								<td width="100">{ $actionReturn.searchdata.salesagent } </td>
								<td>
									Status
								</td>
								<td>
							...
							<td width="100">
									{$actionReturn.searchdata.bill_country}
							</td>
							<td>State</td>
								<td id="id_search_bill_state">{$actionReturn.searchdata.bill_state}</td>
							</tr>
							<tr>
							<td>
								Application
