<?php /* Smarty version 2.6.19, created on 2011-01-24 01:57:39
         compiled from customerSitePoints.tpl.html */ ?>
...
<?php endif; ?>
<tr>
	<td class="pageHead"><span id="sitepoint"><strong>Customer Site Points</strong></span></td>
</tr>
...
<?php if ($this->_tpl_vars['actionReturn']['searchdata']['cusId'] && $this->_tpl_vars['actionReturn']['headname']): ?>
        Viewing the Site Point Details of &nbsp;<strong><?php echo $this->_tpl_vars['actionReturn']['headname']; ?>
</strong>&nbsp; and Total gain of <strong>&nbsp;<?php echo $this->_tpl_vars['actionReturn']['sitepoints']; ?>
&nbsp;</strong>Sitepoints
        <?php else: ?>
        Total gain of <strong>&nbsp;<?php echo $this->_tpl_vars['actionReturn']['sitepoints']; ?>
&nbsp;</strong>Sitepoints
<?php endif; ?>
    </td>
</tr>
...
" name="txt_date_to" id="txt_date_to" readonly=""  class="dateTextBox"/>
							...
							Action
							&nbsp;
                            <?php echo $this->_tpl_vars['actionReturn']['searchCombo']; ?>
...
">
							...
							<th><a href="<?php echo $this->_tpl_vars['obj']->getLink('search','','false'); ?>
&sortField=action&sortMethod=<?php echo $this->_tpl_vars['obj']->getNegativeSort($this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
">Customer Action				
							</a></th>
							<th><a href="<?php echo $this->_tpl_vars['obj']->getLink('search','','false'); ?>
&sortField=sp.point&sortMethod=<?php echo $this->_tpl_vars['obj']->getNegativeSort($this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
">
							Site Ponits
							<?php echo $this->_tpl_vars['obj']->getSortImage('sp.point',$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortField'],$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>

							</a></th>
							<th><a href="<?php echo $this->_tpl_vars['obj']->getLink('search','','false'); ?>
&sortField=sp.date_added&sortMethod=<?php echo $this->_tpl_vars['obj']->getNegativeSort($this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
">
							Added Date
							<?php echo $this->_tpl_vars['obj']->getSortImage('sp.date_added',$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortField'],$this->_tpl_vars['actionReturn']['searchdata']['sortData']['sortMethod']); ?>
...
?>
						<tr>
                            ...
                            <?php endif; ?>
                            <td><?php if ($this->_tpl_vars['data']['name'] == ""): ?>No Deal<?php else: ?><?php echo $this->_tpl_vars['data']['name']; ?>
<?php endif; ?></td>
							<td><?php echo $this->_tpl_vars['data']['action']; ?>
</td>
							<td><a class="helpText" onmouseover="return escape('<?php echo $this->_tpl_vars['data']['sitePntPopUp']; ?>
')"><?php echo $this->_tpl_vars['data']['point']; ?>
</a></td>
					...
					<tr>
                    <?php if ($this->_tpl_vars['actionReturn']['searchdata']['cusId']): ?>
                    <th colspan="5"><?php echo $this->_tpl_vars['actionReturn']['spage']->s_get_links(); ?>
</th>
                    <?php endif; ?>
                    <?php if (! $this->_tpl_vars['actionReturn']['searchdata']['cusId']): ?>
