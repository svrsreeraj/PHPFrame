<?php /* Smarty version 2.6.19, created on 2011-02-18 16:57:25
         compiled from pod_listing.tpl */ ?>
		<tr>
				<td  align="right">&nbsp;</td>
			</tr>
			<tr>
					...
					<div id="id_search_block" class="cls_search_block">
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="searchTable">
							...
							<tr>
								...
								<td name="sel_country"><?php echo $this->_tpl_vars['actionReturn']['country']; ?>
</td>
								<td>State</td>
								<td id="id_search_state" name= "sel_state" style="width:100px; float:left;" ><?php echo $this->_tpl_vars['actionReturn']['state']; ?>
</td>
